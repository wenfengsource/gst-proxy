...
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1026, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1027, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1028, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1029, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1031, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1032, NULL);
g_signal_emit_by_name (source2, "add", "192.168.128.154", 1033, NULL);
...
main (int argc, char *argv[])
{
 ...
 GstElement *testsource2 = NULL;
  ...
  string =
      g_strdup_printf
      ("gst-launch-1.0 -v udpsrc uri=udp://0.0.0.0:1026 ! appsink name=testsink");
  //g_free (filename);
   ...
   * memory. */
  string =
      g_strdup_printf ("appsrc name=testsource is-live=true ! tcpserversink name=multiudpsink sync=false unit-format=GST_FORMAT_TIME host=0.0.0.0 port=8888");
