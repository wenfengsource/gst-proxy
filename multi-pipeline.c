...
//
//
// int Create_source_sink_pipeline( GstCustom *gstcustom , char *inputuri, char*outputuri ,int bindport)
//{
...
// }
//
//int Linksink_to_pipeline(GstCustom *gstcustom, Sink *sink, char *ip, int port)
//{
//	 GstPad *sinkpad;
//	    GstPadTemplate *templ;
//
...
// {
////	 loop = g_main_loop_new (NULL, FALSE);
////	 Create_source_sink_pipeline( GstCustom *gstcustom , char *inputuri, char*outputuri);
